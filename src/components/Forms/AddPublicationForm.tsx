...
export default function AddPublicationForm({ currentUserId }: { currentUserId?: number }) {
  ...
  const handleSubmit = async () => {
    const uid = currentUserId ?? 1; // fallback for dev; replace with your session value
    ...
    form.append("pub_status", "0"); // main author submission=0
    ...
    // TODO: navigate if you want
    router.push('/my_publication')
  };

  return (
    <Box sx={{ bgcolor: "#fff", borderRadius: "8px", boxShadow: 2, maxWidth: 800, mx: "auto" }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", bgcolor: "grey.200",
